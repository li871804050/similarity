...
public class MyBM25Similarity extends Similarity {
    ...
    public final SimWeight computeWeight(float boost, CollectionStatistics collectionStats, TermStatistics... termStats) {
        ...
        return new MyBM25Similarity.MyBM25Stats(collectionStats.field(), boost, idf, avgdl, oldCache, cache);
    }

    @Override
    public final SimScorer simScorer(SimWeight stats, LeafReaderContext context) throws IOException {
        MyBM25Similarity.MyBM25Stats bm25stats = (MyBM25Similarity.MyBM25Stats) stats;
        return new MyBM25Similarity.MyBM25DocScorer(bm25stats, context.reader().getMetaData().getCreatedVersionMajor(), context.reader().getNormValues(bm25stats.field));
    }

    private class MyBM25DocScorer extends SimScorer {
        private final MyBM25Similarity.MyBM25Stats stats;
        ...
        MyBM25DocScorer(MyBM25Similarity.MyBM25Stats stats, int indexCreatedVersionMajor, NumericDocValues norms) throws IOException {
            this.stats = stats;
    ...
    private static class MyBM25Stats extends SimWeight {
        /** BM25's idf */
        ...
        MyBM25Stats(String field, float boost, Explanation idf, float avgdl, float[] oldCache, float[] cache) {
            this.field = field;
            this.boost = boost;
            this.idf = idf;
            this.avgdl = avgdl;
    ...
    private Explanation explainTFNorm(int doc, Explanation freq, MyBM25Similarity.MyBM25Stats stats, NumericDocValues norms, float[] lengthCache) throws IOException {
    ...
    private Explanation explainScore(int doc, Explanation freq, MyBM25Similarity.MyBM25Stats stats, NumericDocValues norms, float[] lengthCache) throws IOException {
     ...
     * @see #MyBM25Similarity(float, float)
     */
